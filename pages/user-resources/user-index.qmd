...
- [Settings and Versions](versions-and-settings.html)
...
[Settings and Versions](versions-and-settings.html) discusses how to check that your version is the most up to date, and to change settings that affect Read Only mode, Test Mode, and the daterange of data you want the application to fetch from the database.
